/**
A slight variant of https://rocketshake.tumblr.com/post/424849450/infinite-scroll
This file has been uploaded to https://static.tumblr.com/fpifyru/F4wm4bbxj/autopager.js
**/
...
var tumblrAutoPager = {
	...
	init: function () {
		...
		function addNextPage(oj) {
			...
			d.innerHTML = "<h2><a href=https://" + tAP.LN + "/page/" + p + ">Page " + p + "</a></h2>";
